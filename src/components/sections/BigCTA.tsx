...
export function BigCTA({ data = landing.bigCta }: { data?: LandingContent['bigCta'] }) {
  const { eyebrow, title, sub, primaryCta, secondaryCta, note, aside } = data

  return (
    <section id="cta" className="border-ink-thick scroll-mt-nav border-y bg-yellow">
      <Container>
